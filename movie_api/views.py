...
from movie.models import Genre, Movie,Cast, Review, Comment
from .serializers import CastSerializers, CommentSerializers, GenreSerializers, MovieListSerializers, MovieSerializers, ReviewSerializers
